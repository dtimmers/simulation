...
namespace PrioQueues
{
    public partial class Input5 : Form
    {
        ...
        private void submit_Click(object sender, EventArgs e)
        {
           ...
           bool[] isNum = new bool[11];
           int wrong;
           bool inputCorrect = true;
           string[] names = new string[totQueues];
           ...
           isNum[4] = double.TryParse(meanArr5.Text, out meanArr[4]);

           isNum[5] = double.TryParse(meanProc1.Text, out meanProc[0]);
           isNum[6] = double.TryParse(meanProc2.Text, out meanProc[1]);
           isNum[7] = double.TryParse(meanProc3.Text, out meanProc[2]);
           isNum[8] = double.TryParse(meanProc4.Text, out meanProc[3]);
           isNum[9] = double.TryParse(meanProc5.Text, out meanProc[4]);

           isNum[10] = int.TryParse(intNumWorkers.Text, out numWorkers);
