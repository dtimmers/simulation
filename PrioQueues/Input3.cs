...
namespace PrioQueues
{
    public partial class Input3 : Form
    {
        ...
        private void submit_Click(object sender, EventArgs e)
        {
           ...
           isNum[3] = double.TryParse(meanProc1.Text, out meanProc[0]);
           isNum[4] = double.TryParse(meanProc2.Text, out meanProc[1]);
           isNum[5] = double.TryParse(meanProc3.Text, out meanProc[2]);
